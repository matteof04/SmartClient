...
class HouseDelete: Command {
    private val smartApi: SmartApi by KoinJavaComponent.getKoin().inject()

    override fun getCommandString() = "DELETE"

    override fun getHelpString() = """
        Usage: DELETE <houseId>
        Delete the house with the specified houseId. If some devices are associated to the house, the command will fail
    """.trimIndent()
