...
class DeviceListSuperCommand: SuperCommand() {
    init {
        subCommandHandler.registerCommand(DeviceListHost())
        subCommandHandler.registerCommand(DeviceListHouse())
        subCommandHandler.registerCommand(DeviceListOwner())
    }
