...
class ThDataSuperCommand: SuperCommand() {
    init {
        subCommandHandler.registerCommand(ThDataDetail())
        subCommandHandler.registerCommand(ThDataList())
    }

    override fun getCommandString() = "THDATA"

    override fun getHelpString() = """
        Usage: THDATA <subcommand>
        ThData-related commands
    """.trimIndent()
}