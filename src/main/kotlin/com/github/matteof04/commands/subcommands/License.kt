...
class License: Command {
    ...
    override fun getCommandString() = "LICENSE"
    ...
    override fun execute(handler: CommandHandler, args: List<String>) {
        val license = getLicenseText() ?: exitProcess(1)
        println(license)
    }

    companion object {
        fun getLicenseText(): String? = License::class.java.classLoader.getResource("LICENSE")?.readText()
    }
}